...
changeStatus.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return changeStatus.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
recordPayment.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return recordPayment.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
voidMethod.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return voidMethod.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
generatePdf.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return generatePdf.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
sendEmail.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return sendEmail.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
