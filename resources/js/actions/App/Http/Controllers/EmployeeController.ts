...
/**
 * @see \App\Http\Controllers\EmployeeController::data
 * @see app/Http/Controllers/EmployeeController.php:32
 * @route '/dashboard/employees/data'
 */
 ...
 */
export const show = (
    args: { employee: number | { id: number } } | [employee: number | { id: number }] | number | { id: number },
...
show.url = (
    ...
    return show.definition.url.replace('{employee}', parsedArgs.employee.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 * @see app/Http/Controllers/EmployeeController.php:67
...
edit.url = (
    ...
    return edit.definition.url.replace('{employee}', parsedArgs.employee.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (
    ...
    return update.definition.url.replace('{employee}', parsedArgs.employee.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
const EmployeeController = { index, data, create, show, edit, store, update, destroy };
