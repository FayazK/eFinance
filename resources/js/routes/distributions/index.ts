...
* @see app/Http/Controllers/DistributionController.php:45
...
* @see app/Http/Controllers/DistributionController.php:66
...
* @see app/Http/Controllers/DistributionController.php:93
...
* @see app/Http/Controllers/DistributionController.php:79
* @route '/dashboard/distributions'
*/
...
* @see app/Http/Controllers/DistributionController.php:118
* @route '/dashboard/distributions/{id}'
*/
...
* @see app/Http/Controllers/DistributionController.php:128
* @route '/dashboard/distributions/{id}'
*/
...
* @see app/Http/Controllers/DistributionController.php:137
...
adjustProfit.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return adjustProfit.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @see app/Http/Controllers/DistributionController.php:151
...
* @see app/Http/Controllers/DistributionController.php:164
...
downloadStatement.url = (args: { id: string | number, shareholderId: string | number } | [id: string | number, shareholderId: string | number ], options?: RouteQueryOptions) => {
    ...
    return downloadStatement.definition.url
            .replace('{id}', parsedArgs.id.toString())
