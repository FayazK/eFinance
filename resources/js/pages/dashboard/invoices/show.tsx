...
import { Card, Descriptions, Button, Space, Tag, Table, Tabs, theme, Modal, notification } from 'antd';
import { EditOutlined, FileTextOutlined, DollarOutlined, SendOutlined, StopOutlined, ArrowLeftOutlined } from '@ant-design/icons';
import { Link, router } from '@inertiajs/react';
import AppLayout from '@/layouts/app-layout';
import type { Invoice, InvoiceStatus, Account, InvoicePayment } from '@/types';
import { index, edit, pdf } from '@/routes/invoices';
                ...
                <Card>
                    <div style={{ maxWidth: 800, margin: '0 auto' }}>
                        ...
                        <div style={{ borderBottom: `2px solid ${token.colorBorder}`, paddingBottom: 24, marginBottom: 24 }}>
                            ...
                            <p style={{ fontSize: 16, color: token.colorTextSecondary, margin: '8px 0 0' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 32 }}>
                            <div>
                                <h3 style={{ fontSize: 12, fontWeight: 600, textTransform: 'uppercase', marginBottom: 8 }}>
                                    Bill To
                                </h3>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 24 }}>
                            <div style={{ width: 300 }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: `1px solid ${token.colorBorder}` }}>
                                    <span>Subtotal:</span>
                                ...
                                {invoice.amount_paid > 0 && (
                                    <>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderTop: `1px solid ${token.colorBorder}`, color: token.colorSuccess }}>
                                            <span>Amount Paid:</span>
                                            <span>{invoice.formatted_amount_paid}</span>
                                        </div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', fontSize: 16, fontWeight: 600, color: invoice.balance_due > 0 ? token.colorWarning : token.colorSuccess }}>
                        ...
                        {invoice.client_notes && (
                            <div style={{ marginTop: 32, padding: 16, backgroundColor: token.colorBgLayout, borderRadius: 8 }}>
                                <h4 style={{ fontSize: 12, fontWeight: 600, textTransform: 'uppercase', marginBottom: 8 }}>
                                    Notes
                                </h4>
